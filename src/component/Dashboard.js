        ...
        <div className="">
          <div className="">
            ...
            <div className="">
              ...
              <div
                className="dash"
                style={{ backgroundColor: "rgba(249, 248, 248, 1)" }}
              >
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="row-12 productdetail">
                      <div className="col-lg-7">
                        <ul>
                          <li className="liOne">
                            Low stock items <span className="noOne">3</span>
                          </li>
                          <li>
                            All items Group <span className="noTwo">39</span>
                          </li>
                          <li>
                            All items <span className="noThree">190</span>
                          </li>
                          <li className="liFour">
                            Unconfirmed item <span className="noFour">121</span>
                          </li>
                        </ul>
                      </div>
